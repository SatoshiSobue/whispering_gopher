...
func main() {
	...
	go dial(*dialAddr) // TODO: Launch dial in a new goroutine, passing in *dialAddr.
...
func dial(addr string) {
	c, err := net.Dial("tcp", addr) // TODO: Open a new connection using the value of the "dial" flag.
	if err != nil {
		log.Fatal(err)
